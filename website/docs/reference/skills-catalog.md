...
| [`minimal-change`](/docs/user-guide/skills/bundled/software-development/software-development-minimal-change) | Use only when asked for the smallest sufficient code change. | `software-development/minimal-change` |
